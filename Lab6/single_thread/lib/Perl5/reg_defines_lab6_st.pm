...
#
# Project: YLR_RISC_CPU (lab6_st)
# Description: Single Thread
#
#############################################################

package reg_defines_lab6_st;
...
@EXPORT = qw(
                ...
                IN_ARB_STATE_REG
                YLR_RISC_CPU_COMMAND_CPU_REG
                YLR_RISC_CPU_ADDRESS_CPU_REG
                YLR_RISC_CPU_IMEM_REG
                YLR_RISC_CPU_DMEM_WRITE_LOWER32_REG
                YLR_RISC_CPU_DMEM_WRITE_UPPER32_REG
                YLR_RISC_CPU_DMEM_READ_LOWER32_REG
                YLR_RISC_CPU_DMEM_READ_UPPER32_REG
                YLR_RISC_CPU_REGFILE_READ_LOWER32_REG
                YLR_RISC_CPU_REGFILE_READ_UPPER32_REG
                OQ_QUEUE_0_CTRL_REG
...
sub DEVICE_PROJ_DIR ()  { "lab6_st"; }
sub DEVICE_PROJ_NAME () { "YLR_RISC_CPU"; }
sub DEVICE_PROJ_DESC () { "Single Thread"; }
...
sub YLR_RISC_CPU_BASE_ADDR ()    { 0x2000200; }
...
# Name: ylr_risc_cpu (YLR_RISC_CPU)
# Description: Registers for RISC CPU
# File: projects/lab6_st/include/ylr_risc_cpu.xml
sub YLR_RISC_CPU_COMMAND_CPU_REG ()            { 0x2000200;}
sub YLR_RISC_CPU_ADDRESS_CPU_REG ()            { 0x2000204;}
sub YLR_RISC_CPU_IMEM_REG ()                   { 0x2000208;}
sub YLR_RISC_CPU_DMEM_WRITE_LOWER32_REG ()     { 0x200020c;}
sub YLR_RISC_CPU_DMEM_WRITE_UPPER32_REG ()     { 0x2000210;}
sub YLR_RISC_CPU_DMEM_READ_LOWER32_REG ()      { 0x2000214;}
sub YLR_RISC_CPU_DMEM_READ_UPPER32_REG ()      { 0x2000218;}
sub YLR_RISC_CPU_REGFILE_READ_LOWER32_REG ()   { 0x200021c;}
sub YLR_RISC_CPU_REGFILE_READ_UPPER32_REG ()   { 0x2000220;}
