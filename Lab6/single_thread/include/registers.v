...
`define YLR_RISC_CPU_BLOCK_ADDR_WIDTH   19
`define YLR_RISC_CPU_REG_ADDR_WIDTH     4
...
`define YLR_RISC_CPU_BLOCK_ADDR   19'h00008
...
`define YLR_RISC_CPU_COMMAND_CPU           4'h0
`define YLR_RISC_CPU_ADDRESS_CPU           4'h1
`define YLR_RISC_CPU_IMEM                  4'h2
`define YLR_RISC_CPU_DMEM_WRITE_LOWER32    4'h3
`define YLR_RISC_CPU_DMEM_WRITE_UPPER32    4'h4
`define YLR_RISC_CPU_DMEM_READ_LOWER32     4'h5
`define YLR_RISC_CPU_DMEM_READ_UPPER32     4'h6
`define YLR_RISC_CPU_REGFILE_READ_LOWER32  4'h7
`define YLR_RISC_CPU_REGFILE_READ_UPPER32  4'h8
