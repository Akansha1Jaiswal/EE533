...
def YLR_ARM_CPU_COMMAND_CPU_REG ():  
    return 0x2000200

def YLR_ARM_CPU_ADDRESS_CPU_REG ():  
    return 0x2000204

def YLR_ARM_CPU_IMEM_REG ():         
    return 0x2000208

def YLR_ARM_CPU_DMEM_REG ():         
    return 0x200020c

def YLR_ARM_CPU_DMEM_READ_REG ():    
    return 0x2000210

def YLR_ARM_CPU_REGFILE_READ_REG (): 
    return 0x2000214
...
__main__.nf_regmap.update({
    ...
    0x2000200 : "YLR_ARM_CPU_COMMAND_CPU_REG",
    0x2000204 : "YLR_ARM_CPU_ADDRESS_CPU_REG",
    0x2000208 : "YLR_ARM_CPU_IMEM_REG",
    0x200020c : "YLR_ARM_CPU_DMEM_REG",
    0x2000210 : "YLR_ARM_CPU_DMEM_READ_REG",
    0x2000214 : "YLR_ARM_CPU_REGFILE_READ_REG",
