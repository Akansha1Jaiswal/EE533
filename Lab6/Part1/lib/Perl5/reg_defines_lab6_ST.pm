...
#
# Project: YLR ARM CPU (lab6_ST)
# Description: ARM CPU Pipeline
#
#############################################################
...
@EXPORT = qw(
                ...
                IN_ARB_STATE_REG
                YLR_ARM_CPU_COMMAND_CPU_REG
                YLR_ARM_CPU_ADDRESS_CPU_REG
                YLR_ARM_CPU_IMEM_REG
                YLR_ARM_CPU_DMEM_REG
                YLR_ARM_CPU_DMEM_READ_REG
                YLR_ARM_CPU_REGFILE_READ_REG
                OQ_QUEUE_0_CTRL_REG
...
sub DEVICE_PROJ_NAME () { "YLR ARM CPU"; }
sub DEVICE_PROJ_DESC () { "ARM CPU Pipeline"; }
...
sub YLR_ARM_CPU_BASE_ADDR ()     { 0x2000200; }
...
# Name: ylr_arm_cpu (YLR_ARM_CPU)
# Description: Registers for ARM CPU
# File: projects/lab6_ST/include/ylr_arm_cpu.xml
sub YLR_ARM_CPU_COMMAND_CPU_REG ()    { 0x2000200;}
sub YLR_ARM_CPU_ADDRESS_CPU_REG ()    { 0x2000204;}
sub YLR_ARM_CPU_IMEM_REG ()           { 0x2000208;}
sub YLR_ARM_CPU_DMEM_REG ()           { 0x200020c;}
sub YLR_ARM_CPU_DMEM_READ_REG ()      { 0x2000210;}
sub YLR_ARM_CPU_REGFILE_READ_REG ()   { 0x2000214;}
