...
`define YLR_ARM_CPU_BLOCK_ADDR_WIDTH    19
`define YLR_ARM_CPU_REG_ADDR_WIDTH      4
...
`define YLR_ARM_CPU_BLOCK_ADDR    19'h00008
...
`define YLR_ARM_CPU_COMMAND_CPU   4'h0
`define YLR_ARM_CPU_ADDRESS_CPU   4'h1
`define YLR_ARM_CPU_IMEM          4'h2
`define YLR_ARM_CPU_DMEM          4'h3
`define YLR_ARM_CPU_DMEM_READ     4'h4
`define YLR_ARM_CPU_REGFILE_READ  4'h5
