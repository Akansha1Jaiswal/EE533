...
def YLR_RISC_CPU_COMMAND_CPU_REG ():          
    return 0x2000200

def YLR_RISC_CPU_ADDRESS_CPU_REG ():          
    return 0x2000204

def YLR_RISC_CPU_IMEM_REG ():                 
    return 0x2000208

def YLR_RISC_CPU_DMEM_WRITE_LOWER32_REG ():   
    return 0x200020c

def YLR_RISC_CPU_DMEM_WRITE_UPPER32_REG ():   
    return 0x2000210

def YLR_RISC_CPU_DMEM_READ_LOWER32_REG ():    
    return 0x2000214

def YLR_RISC_CPU_DMEM_READ_UPPER32_REG ():    
    return 0x2000218

def YLR_RISC_CPU_REGFILE_READ_LOWER32_REG (): 
    return 0x200021c

def YLR_RISC_CPU_REGFILE_READ_UPPER32_REG (): 
    return 0x2000220
...
__main__.nf_regmap.update({
    ...
    0x2000200 : "YLR_RISC_CPU_COMMAND_CPU_REG",
    0x2000204 : "YLR_RISC_CPU_ADDRESS_CPU_REG",
    0x2000208 : "YLR_RISC_CPU_IMEM_REG",
    0x200020c : "YLR_RISC_CPU_DMEM_WRITE_LOWER32_REG",
    0x2000210 : "YLR_RISC_CPU_DMEM_WRITE_UPPER32_REG",
    0x2000214 : "YLR_RISC_CPU_DMEM_READ_LOWER32_REG",
    0x2000218 : "YLR_RISC_CPU_DMEM_READ_UPPER32_REG",
    0x200021c : "YLR_RISC_CPU_REGFILE_READ_LOWER32_REG",
    0x2000220 : "YLR_RISC_CPU_REGFILE_READ_UPPER32_REG",
