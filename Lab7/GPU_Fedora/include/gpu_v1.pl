...
my $SIMPLE_GPU_COMMAND_REG          = 0x2000200;
my $SIMPLE_GPU_ADDRESS_REG          = 0x2000204;
my $SIMPLE_GPU_IMEM_REG             = 0x2000208;
my $SIMPLE_GPU_DMEM_WRITE_LOWER32   = 0x200020C;
my $SIMPLE_GPU_DMEM_WRITE_UPPER32   = 0x2000210;
my $SIMPLE_GPU_DMEM_READ_LOWER32    = 0x2000214;
my $SIMPLE_GPU_DMEM_READ_UPPER32    = 0x2000218;
my $SIMPLE_GPU_REGFILE_READ_LOWER32 = 0x200021C;
my $SIMPLE_GPU_REGFILE_READ_UPPER32 = 0x2000220;
...
my @program = (
    ...
    [ 35, 0x00A90000, "LOAD  r10, MEM[r9]"             ],
    [ 36, 0x00000000, "NOP"                            ],
    [ 37, 0x00000000, "NOP"                            ],
    [ 38, 0x00000000, "NOP"                            ],
    [ 39, 0x30BA1000, "VADD  r11, r10, r1"             ],
    [ 40, 0x00000000, "NOP"                            ],
    [ 41, 0x00000000, "NOP"                            ],
    [ 42, 0x00000000, "NOP"                            ],
    [ 43, 0xC0C12300, "MMA   r12, r1, r2, r3"          ],
    [ 44, 0x00000000, "NOP"                            ],
    [ 45, 0x00000000, "NOP"                            ],
    [ 46, 0x00000000, "NOP"                            ],
    [ 47, 0x00000000, "NOP -- tensor drain"            ],
    [ 48, 0x00000000, "NOP -- tensor drain"            ],
    [ 49, 0x00000000, "NOP -- tensor drain"            ],
    [ 50, 0x00000000, "NOP -- tensor drain"            ],
    [ 51, 0x30DC2000, "VADD  r13, r12, r2"             ],
    [ 52, 0x00000000, "NOP"                            ],
    [ 53, 0x00000000, "NOP"                            ],
    [ 54, 0x00000000, "NOP"                            ],
);
...
# ============================================================
print "\n=== DMEM CHECK ===\n";
my ($dmem_u, $dmem_l) = read_dmem(1);
my $dmem_hex = sprintf("0x%08x%08x", $dmem_u, $dmem_l);
printf("  DMEM[1] = %s", $dmem_hex);
