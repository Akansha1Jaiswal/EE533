...
module gpu_top_wrapper 
   ...
   #( 
      ...
      .TAG                 (`SIMPLE_GPU_BLOCK_ADDR),          // Tag -- eg. MODULE_TAG
      .REG_ADDR_WIDTH      (`SIMPLE_GPU_REG_ADDR_WIDTH),     // Width of block addresses -- eg. MODULE_REG_ADDR_WIDTH
