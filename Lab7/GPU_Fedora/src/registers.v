...
`define DEVICE_PROJ_DIR    "Lab7_GPU"
`define DEVICE_PROJ_NAME   "SIMPLE_GPU"
`define DEVICE_PROJ_DESC   "SIMD GPU with Tensor Core"
...
`define SIMPLE_GPU_BLOCK_ADDR_WIDTH   19
`define SIMPLE_GPU_REG_ADDR_WIDTH     4
...
`define SIMPLE_GPU_BLOCK_ADDR   19'h00008
...
`define SIMPLE_GPU_COMMAND_CPU           4'h0
`define SIMPLE_GPU_ADDRESS_CPU           4'h1
`define SIMPLE_GPU_IMEM                  4'h2
`define SIMPLE_GPU_DMEM_WRITE_LOWER32    4'h3
`define SIMPLE_GPU_DMEM_WRITE_UPPER32    4'h4
`define SIMPLE_GPU_DMEM_READ_LOWER32     4'h5
`define SIMPLE_GPU_DMEM_READ_UPPER32     4'h6
`define SIMPLE_GPU_REGFILE_READ_LOWER32  4'h7
`define SIMPLE_GPU_REGFILE_READ_UPPER32  4'h8
