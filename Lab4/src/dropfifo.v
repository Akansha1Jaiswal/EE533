...
// /___/   /\     Timestamp : 02/01/2026 22:59:52
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2p -w C:/Xilinx/10.1/ISE/Lab_YLR/mini_IDS/dropfifo.sch dropfifo.vf
...
module dropfifo(clk, 
   ...
   COMP8_MXILINX_dropfifo XLXI_8 (.A(waddr[7:0]), 
                                  .B(raddr[7:0]), 
                                  .EQ(XLXN_25));
   // synthesis attribute HU_SET of XLXI_8 is "XLXI_8_19"
   OR2 XLXI_9 (.I0(XLXN_9), 
               .I1(XLXN_8), 
               .O(XLXN_10));
   AND2B1 XLXI_10 (.I0(XLXN_13), 
                   .I1(XLXN_10), 
                   .O(XLXN_16));
   AND3B2 XLXI_11 (.I0(XLXN_23), 
                   .I1(XLXN_25), 
                   .I2(fiforead), 
                   .O(XLXN_26));
   ...
   CB8CLE_MXILINX_dropfifo XLXI_13 (.C(clk), 
                                    .CE(XLXN_15), 
                                    .CLR(rst), 
                                    .D(XLXN_20[7:0]), 
                                    .L(XLXN_13), 
                                    ...
                                    .Q(waddr[7:0]), 
                                    .TC());
   // synthesis attribute HU_SET of XLXI_13 is "XLXI_13_21"
   reg9B XLXI_14 (.ce(XLXN_34), 
                  .clk(clk), 
                  .clr(rst), 
                  .d(in_fifo[71:0]), 
                  .q(in_fifo0[71:0]));
   dual9Bmem XLXI_16 (.addra(waddr[7:0]), 
                      .addrb(raddr[7:0]), 
                      .clka(clk), 
                      .clkb(clk), 
                      .dina(in_fifo0[71:0]), 
