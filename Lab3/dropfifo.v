...
// /___/   /\     Timestamp : 01/28/2026 22:13:35
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2p -w "C:/Documents and Settings/student/My Documents/Lab3New/Lab3_New_IDS/dropfifo.sch" dropfifo.vf
...
module dropfifo(clk, 
   ...
   COMP8_MXILINX_dropfifo XLXI_6 (.A(XLXN_57[7:0]), 
                                  .B(XLXN_19[7:0]), 
                                  .EQ(XLXN_40));
   // synthesis attribute HU_SET of XLXI_6 is "XLXI_6_17"
   COMP8_MXILINX_dropfifo XLXI_7 (.A(XLXN_19[7:0]), 
                                  .B(XLXN_21[7:0]), 
                                  .EQ(XLXN_41));
   ...
   CB8CLE_MXILINX_dropfifo XLXI_11 (.C(clk), 
                                    ...
                                    .Q(XLXN_57[7:0]), 
                                    .TC());
   // synthesis attribute HU_SET of XLXI_11 is "XLXI_11_19"
   CB8CE_MXILINX_dropfifo XLXI_12 (.C(clk), 
                                   ...
                                   .Q(XLXN_19[7:0]), 
                                   .TC());
   // synthesis attribute HU_SET of XLXI_12 is "XLXI_12_20"
   FDC XLXI_13 (.C(clk), 
                .CLR(rst), 
                .D(XLXN_51), 
                .Q(valid_data));
   defparam XLXI_13.INIT = 1'b0;
   reg9B XLXI_22 (.ce(XLXN_103), 
                  .clk(clk), 
                  .clr(rst), 
                  .d(in_fifo[71:0]), 
                  .q(XLXN_93[71:0]));
   AND3B2 XLXI_42 (.I0(XLXN_41), 
                   .I1(XLXN_40), 
                   .I2(fiforead), 
                   .O(XLXN_51));
   VCC XLXI_58 (.P(XLXN_103));
   dualport_9B XLXI_59 (.addra(XLXN_57[7:0]), 
                        .addrb(XLXN_19[7:0]), 
                        .clka(clk), 
                        .clkb(clk), 
                        .dina(XLXN_93[71:0]), 
