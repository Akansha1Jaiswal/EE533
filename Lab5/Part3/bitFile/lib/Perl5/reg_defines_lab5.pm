...
#
# Project: YLRCPU (lab5)
# Description: Skeleton Pipeline
#
#############################################################

package reg_defines_lab5;
...
@EXPORT = qw(
                ...
                YLRCPU_COMMAND_YLRCPU_REG
                YLRCPU_ADDRESS_YLRCPU_REG
                YLRCPU_IMEM_REG
                YLRCPU_UPPER_DMEM_REG
                YLRCPU_LOWER_DMEM_REG
                YLRCPU_UPPER_DMEM_READ_REG
                YLRCPU_LOWER_DMEM_READ_REG
...
sub DEVICE_PROJ_DIR ()  { "lab5"; }
sub DEVICE_PROJ_NAME () { "YLRCPU"; }
sub DEVICE_PROJ_DESC () { "Skeleton Pipeline"; }
...
sub YLRCPU_BASE_ADDR ()          { 0x2000100; }
...
# File: projects/lab5/include/ylrcpu.xml
sub YLRCPU_COMMAND_YLRCPU_REG ()    { 0x2000100;}
sub YLRCPU_ADDRESS_YLRCPU_REG ()    { 0x2000104;}
sub YLRCPU_IMEM_REG ()              { 0x2000108;}
sub YLRCPU_UPPER_DMEM_REG ()        { 0x200010c;}
sub YLRCPU_LOWER_DMEM_REG ()        { 0x2000110;}
sub YLRCPU_UPPER_DMEM_READ_REG ()   { 0x2000114;}
sub YLRCPU_LOWER_DMEM_READ_REG ()   { 0x2000118;}
